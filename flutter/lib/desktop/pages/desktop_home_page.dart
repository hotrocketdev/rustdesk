  ...
  Widget buildHelpCards(String updateUrl) {
    if (!bind.isCustomClient() &&
      ...
      GestureTapCallback onPressed = () async {
        final Uri url = Uri.parse('https://my.deskzap.co.uk/install/access');
        await launchUrl(url);
      };
      if (isToUpdate) {
        onPressed = () {
      ...
      return buildInstallCard(
          ...
          link: isToUpdate
              ? 'https://github.com/hotrocketdev/rustdesk/releases/tag/${bind.mainGetNewVersion()}'
              : null);
    }
    ...
    if (isWindows && !bind.isDisableInstallation()) {
      ...
      if (bind.isSelinuxEnforcing()) {
        ...
        if (bind.mainGetLocalOption(key: keyShowSelinuxHelpTip) != 'N') {
          LinuxCards.add(buildInstallCard(
            ...
            help: 'Help',
            link:
                'https://support.deskzap.co.uk/articles/installation-instructions.html',
            closeButton: true,
      ...
      if (bind.mainCurrentIsWayland()) {
        LinuxCards.add(buildInstallCard(
            ...
            marginTop: LinuxCards.isEmpty ? 20.0 : 5.0,
            help: 'Help',
            link: 'https://support.deskzap.co.uk/articles/installation-instructions.html'));
