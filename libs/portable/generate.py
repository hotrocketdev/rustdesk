...
def write_package_metadata(md5_table: dict, output_folder: str, exe: str):
    ...
    with open(output_path, "wb") as f:
        f.write("deskzap".encode(encoding=encoding))
...
# Windows: python3 .\generate.py -f ..\runtime\flutter\build\windows\runner\Debug\ -o . -e ..\runtime\flutter\build\windows\runner\Debug\deskzap.exe
