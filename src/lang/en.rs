...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ("desk_tip", "Share this device securely with your Deskzap workspace."),
        ("connecting_status", "Connecting to the Deskzap network..."),
        ...
        ("install_tip", "Install Deskzap to this system to improve unattended access, permissions, and session reliability."),
        ("config_acc", "In order to control your Desktop remotely, you need to grant Deskzap \"Accessibility\" permissions."),
        ("config_screen", "In order to access your Desktop remotely, you need to grant Deskzap \"Screen Recording\" permissions."),
        ...
        ("Your Desktop", "This device"),
        ("Control Remote Desktop", "Connect to a device"),
        ("Transfer file", "File transfer"),
        ("Recent sessions", "Recent devices"),
        ("Favorites", "Saved devices"),
        ("Address book", "Workspace devices"),
        ("Empty", "No devices yet."),
        ("Service is not running", "Background service is not running"),
        ...
        ("android_input_permission_tip1", "In order for a remote device to control your Android device via mouse or touch, you need to allow Deskzap to use the \"Accessibility\" service."),
        ("android_input_permission_tip2", "Please go to the next system settings page, find and enter [Installed Services], turn on [Deskzap Input] service."),
        ...
        ("doc_mac_permission", "https://support.deskzap.co.uk/articles/installation-instructions.html"),
        ("Ignore Battery Optimizations", "Ignore battery optimizations"),
        ("android_open_battery_optimizations_tip", "If you want to disable this feature, please go to the next Deskzap application settings page, find and enter [Battery], Uncheck [Unrestricted]"),
        ...
        ("config_input", "In order to control remote desktop with keyboard, you need to grant Deskzap \"Input Monitoring\" permissions."),
        ("config_microphone", "In order to speak remotely, you need to grant Deskzap \"Record Audio\" permissions."),
        ...
        ("still_click_uac_tip", "Still requires the remote user to click OK on the UAC window of running Deskzap."),
        ...
        ("verify_rustdesk_password_tip", "Verify Deskzap password"),
        ...
        ("scam_text1", "If you are on the phone with someone you DON'T know AND TRUST who has asked you to use Deskzap and start the service, do not proceed and hang up immediately."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Please upgrade the Deskzap relay services to version {} or newer!"),
        ("pull_group_failed_tip", "Failed to refresh group"),
        ("doc_fix_wayland", "https://support.deskzap.co.uk/articles/installation-instructions.html"),
        ("display_is_plugged_out_msg", "The display is plugged out, switch to the first display."),
        ("selinux_tip", "SELinux is enabled on your device, which may prevent Deskzap Host from running properly as the controlled side."),
        ...
        ("powered_by_me", "Powered by Deskzap"),
        ("outgoing_only_desk_tip", "Use Deskzap Connect to reach your workspace devices securely."),
        ...
        ("allow-only-conn-window-open-tip", "Only allow connection if Deskzap window is open"),
        ...
        ("floating_window_tip", "It helps to keep the Deskzap background service running"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Please upgrade the Deskzap client to version {} or newer on the remote side!"),
        ...
        ("allow-insecure-tls-fallback-tip", "By default, Deskzap verifies the server certificate for protocols using TLS.\nWith this option enabled, Deskzap will fall back to skipping the verification step and proceed in case of verification failure."),
        ("disable-udp-tip", "Controls whether to use TCP only.\nWhen this option is enabled, Deskzap will not use UDP 21116 any more, TCP 21116 will be used instead."),
        ("server-oss-not-support-tip", "NOTE: the basic relay service build doesn't include this feature."),
